package com.misanthropy.collections_of_optimizations.mixin.dodosmobs;
...
@Pseudo
@Mixin(targets = "com.github.dodo.dodosmobs.client.event.ClientEvent", remap = false)
public abstract class MixinDodosMobsShakeScan {
    ...
    private List<Entity> coo$cacheShakeScan(Level level, Class<Entity> type, AABB box,
        ...
        if (!CoOConfig.dodosmobsCacheShakeScan) {
