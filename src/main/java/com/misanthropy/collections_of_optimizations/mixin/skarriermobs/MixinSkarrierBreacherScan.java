...
import net.mcreator.skarriermobs.procedures.BreacherOnEntityTickUpdateProcedure;
...
@Mixin(value = BreacherOnEntityTickUpdateProcedure.class, remap = false)
public abstract class MixinSkarrierBreacherScan {
    ...
    private static List<Entity> coo$onlyLookAtPlayers(LevelAccessor level, Class<Entity> type, AABB box,
        ...
        if (!CoOConfig.skarriermobsNarrowRegionScans || type != Entity.class || box.getXsize() != 7.0D) {
