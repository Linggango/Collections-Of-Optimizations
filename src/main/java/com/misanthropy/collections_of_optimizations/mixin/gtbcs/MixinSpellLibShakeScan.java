package com.misanthropy.collections_of_optimizations.mixin.gtbcs;
...
@Pseudo
@Mixin(targets = "com.gametechbc.spelllib.events.ForgeClientEvents", remap = false)
public abstract class MixinSpellLibShakeScan {

    @WrapOperation(
            method = {
                    "onCameraSetup",
                    "processScreenFlashEffects",
                    "processPowerInversionEffects"
            },
            at = @At(
                    value = "INVOKE",
    ...
    private static List<Entity> coo$cacheShakeScan(Level level, Class<Entity> type, AABB box,
        ...
        if (!CoOConfig.gtbcsCacheShakeScan) {
