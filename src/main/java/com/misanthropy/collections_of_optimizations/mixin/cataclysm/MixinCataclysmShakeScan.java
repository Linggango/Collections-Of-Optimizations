...
@Pseudo
@Mixin(targets = "com.github.L_Ender.cataclysm.client.event.ClientEvent", remap = false)
public abstract class MixinCataclysmShakeScan {
    ...
    private List<Entity> coo$cacheShakeScan(Level level, Class<Entity> type, AABB box,
        ...
        if (!CoOConfig.cataclysmCacheShakeScan) {
